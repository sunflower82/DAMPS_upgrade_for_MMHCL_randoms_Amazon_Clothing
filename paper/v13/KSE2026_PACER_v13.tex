...
%% KSE 2026 --- IEEE conference template --- v13
%% Rev13 makes the TAMER (Meng et al. MM 2025) reuse explicit:
%%   * new Sec.IV.C "Relation to TAMER" (adopted / modified / dropped)
%%   * expanded Related Work TAMER paragraph and Abstract
%%   * Figure 1 now shows a blue dashed "TAMER lineage" node
%%     (MACP + Interest-Tree cache) on the encoder side
%%   * Data axis of the 2x2 factorial audit is renamed the
%%     TAMER-style Interest-Tree cache with RSFPGrowth-blended source
...
or dropped. Alongside the shipping contribution we reported a
...
borderline negative on Clothing. Future work: completing (i)~the
Amazon Sports five-seed
